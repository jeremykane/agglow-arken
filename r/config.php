...
define("NAME", "AG Glow Links Analytic"); //This app's name.

define("HOMEPAGE", false); //Should the homepage be displayed?
...
define("DB_NAME", "LinkityDB"); //The database name.



//URL settings.
define("PATH", "r"); //The sub directory in which this script runs.